...
this.axisY[l].crosshair.enabled&&this.axisY[l].renderCrosshair(a,d);if(this.axisY2&&0<this.axisY2.length)for(l=0;l<this.axisY2.length;l++)this.axisY2[l].crosshair&&this.axisY2[l].crosshair.enabled&&this.axisY2[l].renderCrosshair(a,d)}};n.prototype._plotAreaMouseMove=function(a,d){if(this.isDrag&&"none"!==this.plotInfo.axisPlacement){var c=0,b=0,e=c=null,e=0<=this.zoomType.indexOf("x"),f=0<=this.zoomType.indexOf("y"),l=this;"xySwapped"===this.plotInfo.axisPlacement&&(c=f,f=e,e=c);c=this.dragStartPoint.x-
...
this.axisY2[e].renderCrosshair(a,d)}};n.prototype._zoomPanToSelectedRegion=function(a,d,c,b,e){a=this.validateRegion(a,d,c,b,e);d=a.axesWithValidRange;c=a.axesRanges;if(a.isValid)for(b=0;b<d.length;b++)e=c[b],d[b].setViewPortRange(e.val1,e.val2),this.syncCharts&&"y"!=this.zoomType&&this.syncCharts(e.val1,e.val2),this.stockChart&&(this.stockChart._rangeEventParameter={stockChart:this.stockChart,source:"chart",index:this.stockChart.charts.indexOf(this),minimum:e.val1,maximum:e.val2});return a.isValid};
n.prototype.validateRegion=function(a,d,c,b,e){e=e||!1;for(var f=0<=this.zoomType.indexOf("x"),l=0<=this.zoomType.indexOf("y"),t=!1,B=[],k=[],m=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&f||"axisY"===this._axes[p].type&&l)&&k.push(this._axes[p]);for(l=0;l<k.length;l++){var p=k[l],f=!1,q=p.convertPixelToValue({x:a,y:d}),g=p.convertPixelToValue({x:c,y:b});if(q>g)var r=g,g=q,q=r;if(p.scaleBreaks)for(r=0;!f&&r<p.scaleBreaks._appliedBreaks.length;r++)f=p.scaleBreaks._appliedBreaks[r].startValue<=
q&&p.scaleBreaks._appliedBreaks[r].endValue>=g;if(isFinite(p.dataInfo.minDiff))if(r=p.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&(p.logarithmic&&r<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&r<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))B.push(p),m.push({val1:q,val2:g}),t=!0;else if(!e){t=!1;break}}return{isValid:t,axesWithValidRange:B,axesRanges:m}};n.prototype.preparePlotArea=function(){var a=this.plotArea;!w&&
...
a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Ca(a.x1,a.y1,a.x2,a.y2,2)};n.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,t=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var m=this._indexLabels[a],p=m.chartType.toLowerCase(),q,g,l=ka("indexLabelFontColor",m.dataPoint,m.dataSeries),r=ka("indexLabelFontSize",m.dataPoint,m.dataSeries),t=ka("indexLabelFontFamily",m.dataPoint,m.dataSeries),B=ka("indexLabelFontStyle",
m.dataPoint,m.dataSeries),k=ka("indexLabelFontWeight",m.dataPoint,m.dataSeries),h=ka("indexLabelBackgroundColor",m.dataPoint,m.dataSeries);q=ka("indexLabelMaxWidth",m.dataPoint,m.dataSeries);g=ka("indexLabelWrap",m.dataPoint,m.dataSeries);var n=ka("indexLabelLineDashType",m.dataPoint,m.dataSeries),u=ka("indexLabelLineColor",m.dataPoint,m.dataSeries),y=s(m.dataPoint.indexLabelLineThickness)?s(m.dataSeries.options.indexLabelLineThickness)?0:m.dataSeries.options.indexLabelLineThickness:m.dataPoint.indexLabelLineThickness,
b=0<y?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,z={percent:null,total:null},C=null;if(0<=m.dataSeries.type.indexOf("stacked")||"pie"===m.dataSeries.type||"doughnut"===m.dataSeries.type)z=this.getPercentAndTotal(m.dataSeries,m.dataPoint);if(m.dataSeries.indexLabelFormatter||m.dataPoint.indexLabelFormatter)C={chart:this,dataSeries:m.dataSeries,dataPoint:m.dataPoint,index:m.indexKeyword,total:z.total,percent:z.percent};var D=m.dataPoint.indexLabelFormatter?
...
m.dataPoint,m.dataSeries),v=m.direction,e=m.dataSeries.axisX,f=m.dataSeries.axisY,x=!1,h=new ha(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===C?0:-90,text:D,padding:0,backgroundColor:h,textAlign:A,fontSize:r,fontFamily:t,fontWeight:k,fontColor:l,fontStyle:B,textBaseline:"middle"});h.measureText();m.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(m.point.x<c.x1||m.point.x>c.x2||m.point.y<c.y1-1||m.point.y>c.y2+1)continue}else if("rangearea"===
p||"rangesplinearea"===p){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>f.viewportMaximum)continue}else if(0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("bubble")||0<=p.indexOf("scatter")){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.dataPoint.y<f.viewportMinimum||m.dataPoint.y>f.viewportMaximum)continue}else if(0<=p.indexOf("column")||"waterfall"===
p||"error"===p&&!m.axisSwapped){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.bounds.y1>c.y2||m.bounds.y2<c.y1)continue}else if(0<=p.indexOf("bar")||"error"===p){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||m.bounds.x1>c.x2||m.bounds.x2<c.x1)continue}else if("candlestick"===p||"ohlc"===p){if(m.dataPoint.x<e.viewportMinimum||m.dataPoint.x>e.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>f.viewportMaximum)continue}else if(m.dataPoint.x<
e.viewportMinimum||m.dataPoint.x>e.viewportMaximum)continue;l=t=2;"horizontal"===C?(B=h.width,k=h.height):(k=h.width,B=h.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))z="auto",t=4;else if(0<=p.indexOf("stacked"))"auto"===z&&(z="inside");else if("bubble"===p||"scatter"===p)z="inside";q=m.point.x-("horizontal"===C?B/2:B/2-r/2);"inside"!==z?(e=c.y1,f=c.y2,0<v?(g=m.point.y+("horizontal"===C?r/2:0)-k-t-b,g<e&&(g="auto"===z?Math.max(m.point.y,e)+r/2+t:
e+r/2+t,x=g+k>m.point.y)):(g=m.point.y+r/2+t+b,g>f-k&&(g="auto"===z?Math.min(m.point.y,f)+r/2-k-t:f+r/2-k,x=g<m.point.y))):(e=Math.max(m.bounds.y1,c.y1),f=Math.min(m.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<v?Math.max(m.bounds.y1,c.y1)+r/2+t:Math.min(m.bounds.y2,c.y2)+r/2-k+t:(Math.max(m.bounds.y1,c.y1)+Math.min(m.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===C?t:0),0<v?(g=Math.max(m.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(m.point.y-k-t,c.y1+t))):(g=Math.min(m.point.y,
b),g>f-k-t&&("bubble"===p||"scatter"===p)&&(g=Math.min(m.point.y+t,c.y2-k-t))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(z="auto",l=4):0<=p.indexOf("stacked")?"auto"===z&&(z="inside"):"bubble"===p&&(z="inside"),g=m.point.y+r/2-k/2+t,"inside"!==z?(e=c.x1,f=c.x2,0>v?(q=m.point.x-("horizontal"===C?B:B-r/2)-l-b,q<e&&(q="auto"===z?Math.max(m.point.x,e)+l:e+l,x=q+B>m.point.x)):(q=m.point.x+("horizontal"===C?0:r/2)+l+b,q>f-B-l-b&&(q="auto"===z?Math.min(m.point.x,
f)-("horizontal"===C?B:B/2)-l:f-B-l,x=q<m.point.x))):(e=Math.max(m.bounds.x1,c.x1),Math.min(m.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>v?Math.max(m.bounds.x1,c.x1)+r/2+l:Math.min(m.bounds.x2,c.x2)-B/2-l+("horizontal"===C?0:r/2):(Math.max(m.bounds.x1,c.x1)+Math.min(m.bounds.x2,c.x2))/2+("horizontal"===C?0:r/2),q=0>v?Math.max(m.point.x,b)-("horizontal"===C?B/2:0):Math.min(m.point.x,b)-B/2,q=Math.max(q,e));"vertical"===C&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);y&&("inside"!==z&&(0>p.indexOf("bar")&&
("error"!==p||!m.axisSwapped)&&m.point.x>c.x1&&m.point.x<c.x2||!x)&&(0>p.indexOf("column")&&("error"!==p||m.axisSwapped)&&m.point.y>c.y1&&m.point.y<c.y2||!x))&&(d.lineWidth=y,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(N(n,y)),d.beginPath(),d.moveTo(m.point.x,m.point.y),0<=p.indexOf("bar")||"error"===p&&m.axisSwapped?d.lineTo(q+(0<m.direction?-l:B+l)+("vertical"===C?-r/2:0),g+("vertical"===C?-k/2:k/2-r/2)-t):0<=p.indexOf("column")||"error"===p&&!m.axisSwapped?d.lineTo(q+B/2-("horizontal"===
C?0:r/2),g+("vertical"===C?(g-k<m.point.y?0:-k)+t:(g-r/2<m.point.y?k:0)-r/2)):d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===C?g-k<m.point.y?0:-k:(g-r/2<m.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)m=this._indexLabels[a],h=ka("indexLabelBackgroundColor",m.dataPoint,m.dataSeries),m.dataSeries.indexLabelBackgroundColor=s(h)?
w?"transparent":null:h;return d};n.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];c.lineWidth=k.lineThickness;var m=k.dataPoints,p="solid";if(c.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),
p=k.lineDashType,g=N(p,k.lineThickness);c.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=R(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var n=!0,u=0,y,s;c.beginPath();if(0<m.length){for(var C=!1,u=0;u<m.length;u++)if(y=m[u].x.getTime?m[u].x.getTime():m[u].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&
(!k.connectNullData||!C)))if("number"!==typeof m[u].y)0<u&&!(k.connectNullData||C||n)&&(c.stroke(),w&&b.stroke()),C=!0;else{y=a.axisX.convertValueToPixel(y);s=a.axisY.convertValueToPixel(m[u].y);var D=k.dataPointIds[u];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:y,y1:s};n||C?(!n&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,
...
c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<m[u].markerSize||0<k.markerSize){var A=k.getMarkerProperties(u,y,s,c);f.push(A);D=R(D);w&&f.push({x:y,y:s,ctx:b,type:A.type,size:A.size,color:D,borderColor:D,borderThickness:A.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:y,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();
...
animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();for(var f=[],l,t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];c.lineWidth=k.lineThickness;var m=k.dataPoints,p="solid";
if(c.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);c.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=R(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var n=!0,u=0,y,s;c.beginPath();if(0<m.length){for(var C=!1,u=0;u<m.length;u++)if(y=m[u].getTime?m[u].x.getTime():
m[u].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof m[u].y)0<u&&!(k.connectNullData||C||n)&&(c.stroke(),w&&b.stroke()),C=!0;else{var D=s;y=a.axisX.convertValueToPixel(y);s=a.axisY.convertValueToPixel(m[u].y);var A=k.dataPointIds[u];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:y,y1:s};n||C?(!n&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&
k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(y,D),c.lineTo(y,s),w&&(b.lineTo(y,D),b.lineTo(y,s))):(c.beginPath(),c.moveTo(y,s),w&&(b.beginPath(),b.moveTo(y,s))),C=n=!1):(c.lineTo(y,D),w&&b.lineTo(y,D),c.lineTo(y,s),w&&b.lineTo(y,s),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(y,s),w&&(b.stroke(),b.beginPath(),b.moveTo(y,s))));l={x:y,y:s};u<m.length-1&&(h!==(m[u].lineColor||r)||p!==(m[u].lineDashType||k.lineDashType))&&
(c.stroke(),c.beginPath(),c.moveTo(y,s),h=m[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(m[u].lineDashType?(p=m[u].lineDashType,c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<m[u].markerSize||0<k.markerSize)D=k.getMarkerProperties(u,y,s,c),f.push(D),A=R(A),w&&f.push({x:y,y:s,ctx:b,type:D.type,size:D.size,color:A,borderColor:A,borderThickness:D.borderThickness});(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",
dataPoint:m[u],dataSeries:k,point:{x:y,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}X.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderSpline=function(a){function d(a){a=v(a,2);if(0<a.length){b.beginPath();w&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);w&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-
...
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var B=a.dataSeriesIndexes[t],k=this.data[B];b.lineWidth=k.lineThickness;var m=k.dataPoints,p="solid";if(b.setLineDash){var q=N(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=N(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]=
{objectType:"dataSeries",dataSeriesIndex:B};r=R(r);e.strokeStyle=r;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var n=0,u,s,z=[];b.beginPath();if(0<m.length)for(s=!1,n=0;n<m.length;n++)if(u=m[n].getTime?m[n].x.getTime():m[n].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!s)))if("number"!==typeof m[n].y)0<n&&!s&&(k.connectNullData?b.setLineDash&&(0<
z.length&&(k.options.nullDataLineDashType||!m[n-1].lineDashType))&&(z[z.length-1].newLineDashArray=q,p=k.nullDataLineDashType):(d(z),z=[])),s=!0;else{u=a.axisX.convertValueToPixel(u);s=a.axisY.convertValueToPixel(m[n].y);var C=k.dataPointIds[n];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:n,x1:u,y1:s};z[z.length]={x:u,y:s};n<m.length-1&&(h!==(m[n].lineColor||r)||p!==(m[n].lineDashType||k.lineDashType))&&(h=m[n].lineColor||r,z[z.length-1].newStrokeStyle=
h,b.setLineDash&&(m[n].lineDashType?(p=m[n].lineDashType,z[z.length-1].newLineDashArray=N(p,k.lineThickness)):(p=k.lineDashType,z[z.length-1].newLineDashArray=g)));if(0<m[n].markerSize||0<k.markerSize){var D=k.getMarkerProperties(n,u,s,b);l.push(D);C=R(C);w&&l.push({x:u,y:s,ctx:e,type:D.type,size:D.size,color:C,borderColor:C,borderThickness:D.borderThickness})}(m[n].indexLabel||k.indexLabel||m[n].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:m[n],
dataSeries:k,point:{x:u,y:s},direction:0>m[n].y===a.axisY.reversed?1:-1,color:r});s=!1}d(z)}X.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(f.x1,f.y1,
f.width,f.height),e.beginPath());b.restore();b.beginPath();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,B,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?
this.dataPointWidth:1,m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0,p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.dataPointWidth=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&
f>m&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<f)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>m&&(p=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var q=
a.dataSeriesIndexes[m],g=this.data[q],r=g.dataPoints;if(0<r.length)for(var h=5<p&&g.bevelEnabled?!0:!1,f=0;f<r.length;f++)if(r[f].getTime?B=r[f].x.getTime():B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(B);t=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var n=a.axisX.reversed?
l-p<<0:l+p<<0,u;0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ba(c,l,t,n,u,b,0,null,h&&0<=r[f].y,0>r[f].y&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:n,y2:u};b=R(b);w&&ba(this._eventManager.ghostCtx,l,t,n,u,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",
dataPoint:r[f],dataSeries:g,point:{x:l+(n-l)/2,y:0>r[f].y===a.axisY.reversed?t:u},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(t,u),x2:n,y2:Math.max(t,u)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
l[b]?l[b]:0,D=p+A,p=q+A,l[b]=A+(D-p);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];ba(c,z,p,C,D,b,0,null,s&&0<=u[k].y,0>u[k].y&&s,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:C,y2:D};b=R(b);w&&ba(this._eventManager.ghostCtx,z,p,C,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",
dataPoint:u[k],dataSeries:n,point:{x:m,y:0<=u[k].y?p:D},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:z,y1:Math.min(p,D),x2:C,y2:Math.max(p,D)},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
f=[],l=[],t=[],B=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/
Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>m&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<k)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>m&&(g=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],n=this.data[h],u=n.dataPoints;if(0<u.length)for(var s=5<g&&n.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;var z=m-a.plotType.plotUnits.length*g/
2+a.index*g<<0,C=z+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=p+("undefined"!==typeof t[b]?t[b]:0);if(0>=t[b])continue;p=a.axisY.convertValueToPixel(t[b]);D=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=p+("undefined"!==typeof B[b]?B[b]:0),D=a.axisY.convertValueToPixel(B[b]),p=l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(p),0<=u[k].y){var A="undefined"!==typeof f[b]?
f[b]:0;p-=A;D=q-A;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=A+(D-p)}else A="undefined"!==typeof l[b]?l[b]:0,D=p+A,p=q+A,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-D)&&(D=e.y2),l[b]=A+(D-p);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];ba(c,z,p,C,D,b,0,null,s&&0<=u[k].y,0>u[k].y&&s,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:C,y2:D};b=R(b);w&&ba(this._eventManager.ghostCtx,
...
a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){t=a.axisX.convertValueToPixel(B);l=a.axisY.convertValueToPixel(r[f].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var n=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=r[f].y?u=k:(u=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ba(c,u,t,l,n,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];
this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:n};b=R(b);w&&ba(this._eventManager.ghostCtx,u,t,l,n,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:u,y:t+(n-t)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,l),y1:t,x2:Math.max(u,l),y2:n},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,
...
animationBase:k<a.axisY.bounds.x1?a.axisY.bounds.x1:k>a.axisY.bounds.x2?a.axisY.bounds.x2:k}}};n.prototype.renderStackedBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],t=[],B=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;p=this.options.dataPointMaxWidth?
this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>p&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&
p<k)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>p&&(g=p);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],n=this.data[h],u=n.dataPoints;if(0<u.length){var s=5<g&&n.bevelEnabled?!0:!1;c.strokeStyle=
"#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var z=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=z+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(D=f[b]?f[b]:q,f[b]=m=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&
0>=u[k].y)B[b]=u[k].y+(B[b]?B[b]:0),m=l[b]?l[b]:q,l[b]=D=a.axisY.convertValueToPixel(B[b]);else if(m=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var A=f[b]?f[b]:0;D=q+A;m+=A;f[b]=A+(m-D)}else A=l[b]?l[b]:0,D=m-A,m=q-A,l[b]=A+(m-D);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];ba(c,D,z,m,C,b,0,null,s,!1,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:z,x2:m,y2:C};b=R(b);w&&ba(this._eventManager.ghostCtx,
D,z,m,C,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:u[k],dataSeries:n,point:{x:0<=u[k].y?m:D,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(D,m),y1:z,x2:Math.max(D,m),y2:C},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],t=[],B=[],k=0,m,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;p=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0;var g=a.axisX.dataInfo.minDiff;
isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>p&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&p<k)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>p&&(g=p);c.save();w&&
this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],n=this.data[h],u=n.dataPoints;if(0<u.length){var s=5<g&&n.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||
b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var z;z=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;var C=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=C+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=z+(t[b]?t[b]:0);if(0>=t[b])continue;z=f[b]?f[b]:q;f[b]=m=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=
z+(B[b]?B[b]:0),m=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(B[b]);else if(m=a.axisY.convertValueToPixel(z),0<=u[k].y){var A=f[b]?f[b]:0;z=q+A;m+=A;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-m)&&(m=e.x2);f[b]=A+(m-z)}else A=l[b]?l[b]:0,z=m-A,m=q-A,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-z)&&(z=e.x1),l[b]=A+(m-z);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];ba(c,z,C,m,D,b,0,null,s,!1,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,
objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:C,x2:m,y2:D};b=R(b);w&&ba(this._eventManager.ghostCtx,z,C,m,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:u[k],dataSeries:n,point:{x:0<=u[k].y?m:z,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,m),y1:C,x2:Math.max(z,m),y2:D},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,
animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};n.prototype.renderArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=z:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=z),f.lineTo(n,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(n,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(n,
u),l.beginPath(),l.moveTo(n,u),D={x:n,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,m;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,B=g.id;this._eventManager.objectMap[B]=
{objectType:"dataSeries",dataSeriesIndex:q};B=R(B);l.fillStyle=B;B=[];d=!0;var h=0,n,u,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||A,x=v;f.fillStyle=A;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var S=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var O=N(c,g.lineThickness);f.setLineDash(O)}for(var ia=!0;h<r.length;h++)if(s=r[h].x.getTime?
r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ia)))if("number"!==typeof r[h].y)g.connectNullData||(ia||d)||b(),ia=!0;else{n=a.axisX.convertValueToPixel(s);u=a.axisY.convertValueToPixel(r[h].y);d||ia?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=n,c=u,n=m.x,u=m.y,b(),f.moveTo(m.x,m.y),n=d,u=c,D=m,c=g.nullDataLineDashType,f.setLineDash(S)),f.lineTo(n,
u),w&&l.lineTo(n,u)):(f.beginPath(),f.moveTo(n,u),w&&(l.beginPath(),l.moveTo(n,u)),D={x:n,y:u}),ia=d=!1):(f.lineTo(n,u),w&&l.lineTo(n,u),0==h%250&&b());m={x:n,y:u};h<r.length-1&&(x!==(r[h].lineColor||v)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||v,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(O))));var $=g.dataPointIds[h];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:h,x1:n,y1:u};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,n,u,f),B.push(s),$=R($),w&&B.push({x:n,y:u,ctx:l,type:s.type,size:s.size,color:$,borderColor:$,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:n,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A})}b();X.drawMarkers(B)}}w&&
...
!p[q-1].lineDashType))&&(s[s.length-1].newLineDashArray=x,A=m.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var S=m.dataPointIds[q];this._eventManager.objectMap[S]={id:S,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||C)||A!==(p[q].lineDashType||m.lineDashType))&&(D=p[q].lineColor||C,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(A=
p[q].lineDashType,s[s.length-1].newLineDashArray=N(A,m.lineThickness)):(A=m.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<m.markerSize)){var O=m.getMarkerProperties(q,g,r,b);l.push(O);S=R(S);w&&l.push({x:g,y:r,ctx:e,type:O.type,size:O.size,color:S,borderColor:S,borderThickness:O.borderThickness})}(p[q].indexLabel||m.indexLabel||p[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:m,
point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:z});r=!1}d();X.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),
this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=z:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=z),f.lineTo(n,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=
1,w&&(l.lineTo(n,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(n,u),l.beginPath(),l.moveTo(n,u),D={x:n,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,m;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=
a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=R(B);l.fillStyle=B;B=[];d=!0;var h=0,n,u,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;c=!1;if(0<r.length){var A=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||A,x=v;f.fillStyle=A;f.strokeStyle=v;f.lineWidth=g.lineThickness;var S="solid";if(f.setLineDash){var O=N(g.nullDataLineDashType,g.lineThickness),
S=g.lineDashType,E=N(S,g.lineThickness);f.setLineDash(E)}for(;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var $=u;"number"!==typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(n=a.axisX.convertValueToPixel(s),u=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||S===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=n,
c=u,n=m.x,u=m.y,b(),f.moveTo(m.x,m.y),n=d,u=c,D=m,S=g.nullDataLineDashType,f.setLineDash(O)),f.lineTo(n,$),f.lineTo(n,u),w&&(l.lineTo(n,$),l.lineTo(n,u))):(f.beginPath(),f.moveTo(n,u),w&&(l.beginPath(),l.moveTo(n,u)),D={x:n,y:u}),c=d=!1):(f.lineTo(n,$),w&&l.lineTo(n,$),f.lineTo(n,u),w&&l.lineTo(n,u),0==h%250&&b()),m={x:n,y:u},h<r.length-1&&(x!==(r[h].lineColor||v)||S!==(r[h].lineDashType||g.lineDashType))&&(b(),x=r[h].lineColor||v,f.strokeStyle=x,f.setLineDash&&(r[h].lineDashType?(S=r[h].lineDashType,
f.setLineDash(N(S,g.lineThickness))):(S=g.lineDashType,f.setLineDash(E)))),s=g.dataPointIds[h],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:n,y1:u},0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&($=g.getMarkerProperties(h,n,u,f),B.push($),s=R(s),w&&B.push({x:n,y:u,ctx:l,type:$.type,size:$.size,color:s,borderColor:s,borderThickness:$.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stepArea",dataPoint:r[h],dataSeries:g,point:{x:n,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:A}))}b();X.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),
...
a.dataSeriesIndexes[C],A=this.data[D],v=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,A.dataPointIndexes[D]=q,e[D]||(m.push(D),e[D]=!0);m.sort(Qa)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];A=this.data[D];v=A.dataPoints;y=!0;k=[];q=A.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=R(q);s.fillStyle=q;if(0<m.length){var e=A._colorSet[0],x=A.lineColor=A.options.lineColor||e,S=x;b.fillStyle=e;
b.strokeStyle=x;b.lineWidth=A.lineThickness;z="solid";if(b.setLineDash){var O=N(A.nullDataLineDashType,A.lineThickness);z=A.lineDashType;var E=N(z,A.lineThickness);b.setLineDash(E)}for(var $=!0,q=0;q<m.length;q++){var f=m[q],ea=null,ea=0<=A.dataPointIndexes[f]?v[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!$)))if("number"!==typeof ea.y)A.connectNullData||($||y)||d(),$=!0;else{g=a.axisX.convertValueToPixel(f);var la=
h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ea.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ea.y),r-=la;k.push({x:g,y:n-la});h[f]=n-r;y||$?(!y&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||z===A.lineDashType&&A.lineDashType!==A.nullDataLineDashType)&&(y=k.pop(),z=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(z),k.push(y),z=A.nullDataLineDashType,
b.setLineDash(O)),b.lineTo(g,r),w&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(s.beginPath(),s.moveTo(g,r))),$=y=!1):(b.lineTo(g,r),w&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&s.moveTo(g,r),k.push({x:g,y:n-la})));u={x:g,y:r};q<v.length-1&&(S!==(v[q].lineColor||x)||z!==(v[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:n-la}),S=v[q].lineColor||x,b.strokeStyle=S,b.setLineDash&&(v[q].lineDashType?(z=v[q].lineDashType,b.setLineDash(N(z,A.lineThickness))):(z=
A.lineDashType,b.setLineDash(E))));if(0<=A.dataPointIndexes[f]){var F=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<A.markerSize)&&(la=A.getMarkerProperties(A.dataPointIndexes[f],g,r,b),l.push(la),f=R(F),w&&l.push({x:g,y:r,ctx:s,type:la.type,size:la.size,color:f,borderColor:f,borderThickness:la.borderThickness}));(ea.indexLabel||
A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&s.moveTo(g,r)}delete A.dataPointIndexes}X.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderStackedArea100=function(a){function d(){for(0<A.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&z.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=
A.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(z.closePath(),z.fill(),z.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],h=[],k=[],m=[],p=[],q=0,g,r,n,s,u,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z=this._eventManager.ghostCtx;b.save();w&&z.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(z.beginPath(),z.rect(l.x1,l.y1,l.width,
l.height),z.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var v=a.dataSeriesIndexes[C],A=this.data[v],x=A.dataPoints;A.dataPointIndexes=[];for(q=0;q<x.length;q++)v=x[q].x.getTime?x[q].x.getTime():x[q].x,A.dataPointIndexes[v]=q,e[v]||(m.push(v),e[v]=!0);m.sort(Qa)}for(C=0;C<a.dataSeriesIndexes.length;C++){v=a.dataSeriesIndexes[C];A=this.data[v];x=A.dataPoints;s=!0;e=A.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:v};e=R(e);z.fillStyle=e;k=[];if(0<m.length){var e=
A._colorSet[q%A._colorSet.length],E=A.lineColor=A.options.lineColor||e,S=E;b.fillStyle=e;b.strokeStyle=E;b.lineWidth=A.lineThickness;u="solid";if(b.setLineDash){var O=N(A.nullDataLineDashType,A.lineThickness);u=A.lineDashType;var F=N(u,A.lineThickness);b.setLineDash(F)}for(var $=!0,q=0;q<m.length;q++){var f=m[q],ea=null,ea=0<=A.dataPointIndexes[f]?x[A.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!A.connectNullData||!$)))if("number"!==typeof ea.y)A.connectNullData||
($||s)||d(),$=!0;else{var la;la=0!==a.dataPointYSums[f]?100*(ea.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var aa=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=la+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(la),r-=aa;k.push({x:g,y:y-aa});h[f]=y-r;s||$?(!s&&A.connectNullData?(b.setLineDash&&(A.options.nullDataLineDashType||u===A.lineDashType&&
A.lineDashType!==A.nullDataLineDashType)&&(s=k.pop(),u=k[k.length-1],d(),b.moveTo(n.x,n.y),k.push(u),k.push(s),u=A.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,r),w&&z.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(z.beginPath(),z.moveTo(g,r))),$=s=!1):(b.lineTo(g,r),w&&z.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&z.moveTo(g,r),k.push({x:g,y:y-aa})));n={x:g,y:r};q<x.length-1&&(S!==(x[q].lineColor||E)||u!==(x[q].lineDashType||A.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:y-
aa}),S=x[q].lineColor||E,b.strokeStyle=S,b.setLineDash&&(x[q].lineDashType?(u=x[q].lineDashType,b.setLineDash(N(u,A.lineThickness))):(u=A.lineDashType,b.setLineDash(F))));if(0<=A.dataPointIndexes[f]){var G=A.dataPointIds[A.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:A.dataPointIndexes[f],x1:g,y1:r}}0<=A.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<A.markerSize)&&(aa=A.getMarkerProperties(q,g,r,b),t.push(aa),f=R(G),
w&&t.push({x:g,y:r,ctx:z,type:aa.type,size:aa.size,color:f,borderColor:f,borderThickness:aa.borderThickness}));(ea.indexLabel||A.indexLabel||ea.indexLabelFormatter||A.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:A,point:{x:g,y:r},direction:0>x[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&z.moveTo(g,r)}delete A.dataPointIndexes}X.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),z.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderBubble=function(a){var d=
...
f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,s=2*Math.max(Math.sqrt((t===h?n/2:r+(n-r)/(t-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=p.fillOpacity;X.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:e,x1:f,y1:l,size:s};
s=R(u);w&&X.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:p,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null})}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
b.width)/2,2);for(var p=0,q=0,e=0;e<m.length;e++)if(f=m[e].getTime?f=m[e].x.getTime():f=m[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof m[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(m[e].y);var g=k.getMarkerProperties(e,f,l,c);c.globalAlpha=k.fillOpacity;X.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&m.length>Math.min(this.plotArea.width,
this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:l},p=R(p),w&&X.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(m[e].indexLabel||k.indexLabel||m[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:m[e],dataSeries:k,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),
...
"number"===typeof y[t].y[1]&&"number"===typeof y[t].y[2]&&"number"===typeof y[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[t].y[0]);m=a.axisY.convertValueToPixel(y[t].y[1]);p=a.axisY.convertValueToPixel(y[t].y[2]);q=a.axisY.convertValueToPixel(y[t].y[3]);var C=h-r/2<<0,v=C+r<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=y[t].color?y[t].color:u._colorSet[0],A=Math.round(Math.max(1,0.15*r)),x=0===A%2?0:0.5,E=u.dataPointIds[t];this._eventManager.objectMap[E]=
{id:E,objectType:"dataPoint",dataSeriesIndex:Pa,dataPointIndex:t,x1:C,y1:k,x2:v,y2:m,x3:h,y3:p,x4:h,y4:q,borderThickness:A,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=A;b.lineWidth=Math.max(A,4);"candlestick"===u.type?(c.moveTo(h-x,m),c.lineTo(h-x,Math.min(k,q)),c.stroke(),c.moveTo(h-x,Math.max(k,q)),c.lineTo(h-x,p),c.stroke(),ba(c,C,Math.min(k,q),v,Math.max(k,q),y[t].y[0]<=y[t].y[3]?u.risingColor:f,A,e,z,z,!1,!1,u.fillOpacity),w&&(e=R(E),b.strokeStyle=e,b.moveTo(h-x,m),b.lineTo(h-x,Math.min(k,
q)),b.stroke(),b.moveTo(h-x,Math.max(k,q)),b.lineTo(h-x,p),b.stroke(),ba(b,C,Math.min(k,q),v,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-x,m),c.lineTo(h-x,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(C,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(v,q),c.stroke(),w&&(e=R(E),b.strokeStyle=e,b.moveTo(h-x,m),b.lineTo(h-x,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(C,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(v,q),b.stroke()));(y[t].indexLabel||u.indexLabel||
y[t].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:y[t],dataSeries:u,point:{x:C+(v-C)/2,y:a.axisY.reversed?p:m},direction:1,bounds:{x1:C,y1:Math.min(m,p),x2:v,y2:Math.max(m,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
p=a.axisY.convertValueToPixel(z[l].y[3]);q=a.axisY.convertValueToPixel(z[l].y[4]);var D=t-r/2<<0,A=t+r/2<<0,e=z[l].color?z[l].color:y._colorSet[0],x=Math.round(Math.max(1,0.15*r)),E=0===x%2?0:0.5,S=z[l].whiskerColor?z[l].whiskerColor:z[l].color?y.whiskerColor?y.whiskerColor:z[l].color:y.whiskerColor?y.whiskerColor:e,O="number"===typeof z[l].whiskerThickness?z[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:x,F=z[l].whiskerDashType?z[l].whiskerDashType:y.whiskerDashType,
$=s(z[l].whiskerLength)?s(y.options.whiskerLength)?r:y.whiskerLength:z[l].whiskerLength,$="number"===typeof $?0>=$?0:$>=r?r:$:"string"===typeof $?parseInt($)*r/100>r?r:parseInt($)*r/100:r,ea=1===Math.round(O)%2?0.5:0,la=z[l].stemColor?z[l].stemColor:z[l].color?y.stemColor?y.stemColor:z[l].color:y.stemColor?y.stemColor:e,aa="number"===typeof z[l].stemThickness?z[l].stemThickness:"number"===typeof y.options.stemThickness?y.stemThickness:x,G=1===Math.round(aa)%2?0.5:0,I=z[l].stemDashType?z[l].stemDashType:
y.stemDashType,J=z[l].lineColor?z[l].lineColor:z[l].color?y.lineColor?y.lineColor:z[l].color:y.lineColor?y.lineColor:e,K="number"===typeof z[l].lineThickness?z[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:x,P=z[l].lineDashType?z[l].lineDashType:y.lineDashType,L=1===Math.round(K)%2?0.5:0,T=y.upperBoxColor,va=y.lowerBoxColor,qa=s(y.options.fillOpacity)?1:y.fillOpacity,Q=y.dataPointIds[l];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,
x1:D,y1:h,x2:A,y2:k,x3:t,y3:m,x4:t,y4:p,y5:q,borderThickness:x,color:e,stemThickness:aa,stemColor:la,whiskerThickness:O,whiskerLength:$,whiskerColor:S,lineThickness:K,lineColor:J};c.save();0<aa&&(c.beginPath(),c.strokeStyle=la,c.lineWidth=aa,c.setLineDash&&c.setLineDash(N(I,aa)),c.moveTo(t-G,k),c.lineTo(t-G,h),c.stroke(),c.moveTo(t-G,p),c.lineTo(t-G,m),c.stroke());c.restore();b.lineWidth=Math.max(x,4);c.beginPath();ba(c,D,Math.min(q,k),A,Math.max(k,q),va,0,e,n?C:!1,n?!1:C,!1,!1,qa);c.beginPath();
ba(c,D,Math.min(m,q),A,Math.max(q,m),T,0,e,n?!1:C,n?C:!1,!1,!1,qa);c.beginPath();c.lineWidth=x;c.strokeStyle=e;c.rect(D-E,Math.min(k,m)-E,A-D+2*E,Math.max(k,m)-Math.min(k,m)+2*E);c.stroke();c.save();0<K&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(P,K)),c.strokeStyle=J,c.lineWidth=K,c.moveTo(D,q-L),c.lineTo(A,q-L),c.stroke());c.restore();c.save();0<O&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(F,O)),c.strokeStyle=S,c.lineWidth=O,c.moveTo(t-$/2<<0,p-ea),c.lineTo(t+$/2<<0,p-ea),
c.stroke(),c.moveTo(t-$/2<<0,h+ea),c.lineTo(t+$/2<<0,h+ea),c.stroke());c.restore();w&&(e=R(Q),b.strokeStyle=e,b.lineWidth=aa,0<aa&&(b.moveTo(t-E-G,k),b.lineTo(t-E-G,Math.max(h,p)),b.stroke(),b.moveTo(t-E-G,Math.min(h,p)),b.lineTo(t-E-G,m),b.stroke()),ba(b,D,Math.max(k,m),A,Math.min(k,m),e,0,null,!1,!1,!1,!1),0<O&&(b.beginPath(),b.lineWidth=O,b.moveTo(t+$/2,p-ea),b.lineTo(t-$/2,p-ea),b.stroke(),b.moveTo(t+$/2,h+ea),b.lineTo(t-$/2,h+ea),b.stroke()));(z[l].indexLabel||y.indexLabel||z[l].indexLabelFormatter||
...
m)*k<<0,v=a.axisX.reversed?n-k<<0:n+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var u=l;l=t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:n,y1:l,x2:v,y2:t};ba(c,n,l,v,t,b,0,b,r,r,!1,!1,q.fillOpacity);b=R(u);w&&ba(this._eventManager.ghostCtx,n,l,v,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",
...
"source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderError=
...
(u=e);u>t&&(u=t);if(0<D.length)for(var F=C._colorSet,t=0;t<D.length;t++){var e=C.lineColor=C.options.color?C.options.color:F[0],S={color:D[t].whiskerColor?D[t].whiskerColor:D[t].color?C.whiskerColor?C.whiskerColor:D[t].color:C.whiskerColor?C.whiskerColor:e,thickness:s(D[t].whiskerThickness)?C.whiskerThickness:D[t].whiskerThickness,dashType:D[t].whiskerDashType?D[t].whiskerDashType:C.whiskerDashType,length:s(D[t].whiskerLength)?s(C.options.whiskerLength)?u:C.options.whiskerLength:D[t].whiskerLength,
trimLength:s(D[t].whiskerLength)?s(C.options.whiskerLength)?50:0:0};S.length="number"===typeof S.length?0>=S.length?0:S.length>=u?u:S.length:"string"===typeof S.length?parseInt(S.length)*u/100>u?u:parseInt(S.length)*u/100>u:u;S.thickness="number"===typeof S.thickness?0>S.thickness?0:Math.round(S.thickness):2;var O={color:D[t].stemColor?D[t].stemColor:D[t].color?C.stemColor?C.stemColor:D[t].color:C.stemColor?C.stemColor:e,thickness:D[t].stemThickness?D[t].stemThickness:C.stemThickness,dashType:D[t].stemDashType?
D[t].stemDashType:C.stemDashType};O.thickness="number"===typeof O.thickness?0>O.thickness?0:Math.round(O.thickness):2;D[t].getTime?r=D[t].x.getTime():r=D[t].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(D[t].y)&&D[t].y.length&&"number"===typeof D[t].y[0]&&"number"===typeof D[t].y[1]){var ia=a.axisX.convertValueToPixel(r);b?k=ia:h=ia;ia=a.axisY.convertValueToPixel(D[t].y[0]);b?m=ia:q=ia;ia=a.axisY.convertValueToPixel(D[t].y[1]);b?p=ia:g=ia;b?(q=a.axisX.reversed?k+(A?v:
1)*u/2-(A?E-1:0)*u<<0:k-(A?v:1)*u/2+(A?E-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(m=a.axisX.reversed?h+(A?v:1)*u/2-(A?E-1:0)*u<<0:h-(A?v:1)*u/2+(A?E-1:0)*u<<0,p=a.axisX.reversed?m-u<<0:m+u<<0);!b&&q>g&&(ia=q,q=g,g=ia);b&&m>p&&(ia=m,m=p,p=ia);ia=C.dataPointIds[t];this._eventManager.objectMap[ia]={id:ia,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:t,x1:Math.min(m,p),y1:Math.min(q,g),x2:Math.max(p,m),y2:Math.max(g,q),isXYSwapped:b,stemProperties:O,whiskerProperties:S};x(c,Math.min(m,p),
Math.min(q,g),Math.max(p,m),Math.max(g,q),e,S,O,b);w&&x(this._eventManager.ghostCtx,m,q,p,g,e,S,O,b);if(D[t].indexLabel||C.indexLabel||D[t].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:D[t],dataSeries:C,indexKeyword:0,point:{x:b?D[t].y[1]>=D[t].y[0]?m:p:m+(p-m)/2,y:b?q+(g-q)/2:D[t].y[1]>=D[t].y[0]?g:q},direction:D[t].y[1]>=D[t].y[0]?-1:1,bounds:{x1:b?Math.min(m,p):m,y1:b?q:Math.min(q,g),x2:b?Math.max(m,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),
...
t=a.axisY.convertValueToPixel(r[f].y[1]);h=a.axisX.convertValueToPixel(k);h=a.axisX.reversed?h+a.plotType.totalDataSeries*m/2-(a.previousDataSeriesCount+p)*m<<0:h-a.plotType.totalDataSeries*m/2+(a.previousDataSeriesCount+p)*m<<0;var v=a.axisX.reversed?h-m<<0:h+m<<0;l>t&&(b=l,l=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];ba(c,l,h,t,v,b,0,null,n,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,
x1:l,y1:h,x2:t,y2:v};b=R(b);w&&ba(this._eventManager.ghostCtx,l,h,t,v,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:t,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeArea=function(a){function d(){if(y){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<m.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],
...
for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],m=this.data[k],p=m.dataPoints,f=m.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=R(f);e.fillStyle=f;var f=[],q=!0,g=0,r,n,s,u,y=null;if(0<p.length){var z=m._colorSet[g%m._colorSet.length],v=m.lineColor=m.options.lineColor||z,D=v;b.fillStyle=z;b.strokeStyle=v;b.lineWidth=m.lineThickness;var A="solid";if(b.setLineDash){var x=N(m.nullDataLineDashType,m.lineThickness),A=m.lineDashType,E=N(A,
m.lineThickness);b.setLineDash(E)}for(var S=!0;g<p.length;g++)if(u=p[g].x.getTime?p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!S)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(u);n=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||S?(m.connectNullData&&!q?(b.setLineDash&&(m.options.nullDataLineDashType||A===m.lineDashType&&
...
1&&(D!==(p[g].lineColor||v)||A!==(p[g].lineDashType||m.lineDashType))&&(d(),D=p[g].lineColor||v,h[h.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&(p[g].lineDashType?(A=p[g].lineDashType,h[h.length-1].newLineDashArray=N(A,m.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(A=m.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<m.markerSize)){var O=m.getMarkerProperties(g,r,s,b);f.push(O);var F=R(u);w&&f.push({x:r,
y:s,ctx:e,type:O.type,size:O.size,color:F,borderColor:F,borderThickness:O.borderThickness});O=m.getMarkerProperties(g,r,n,b);f.push(O);F=R(u);w&&f.push({x:r,y:n,ctx:e,type:O.type,size:O.size,color:F,borderColor:F,borderThickness:O.borderThickness})}if(p[g].indexLabel||m.indexLabel||p[g].indexLabelFormatter||m.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:m,indexKeyword:0,point:{x:r,y:n},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:z}),this._indexLabels.push({chartType:"rangeArea",
dataPoint:p[g],dataSeries:m,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:z})}else S||q||d(),S=!0;d();X.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],m=k.dataPoints,f=k.id;this._eventManager.objectMap[f]=
{objectType:"dataSeries",dataSeriesIndex:h};f=R(f);e.fillStyle=f;var f=[],p=0,q,g,n,s=[],x=[];if(0<m.length){var u=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||u,z=y;b.fillStyle=u;b.lineWidth=k.lineThickness;var C="solid",D;if(b.setLineDash){var A=N(k.nullDataLineDashType,k.lineThickness),C=k.lineDashType;D=N(C,k.lineThickness)}for(g=!1;p<m.length;p++)if(q=m[p].x.getTime?m[p].x.getTime():m[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||
!g)))if(null!==m[p].y&&m[p].y.length&&"number"===typeof m[p].y[0]&&"number"===typeof m[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(m[p].y[0]);n=a.axisY.convertValueToPixel(m[p].y[1]);var E=k.dataPointIds[p];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:n};s[s.length]={x:q,y:g};x[x.length]={x:q,y:n};p<m.length-1&&(z!==(m[p].lineColor||y)||C!==(m[p].lineDashType||k.lineDashType))&&(z=m[p].lineColor||y,s[s.length-
1].newStrokeStyle=z,b.setLineDash&&(m[p].lineDashType?(C=m[p].lineDashType,s[s.length-1].newLineDashArray=N(C,k.lineThickness)):(C=k.lineDashType,s[s.length-1].newLineDashArray=D)));if(0!==m[p].markerSize&&(0<m[p].markerSize||0<k.markerSize)){var F=k.getMarkerProperties(p,q,g,b);f.push(F);var S=R(E);w&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:S,borderColor:S,borderThickness:F.borderThickness});F=k.getMarkerProperties(p,q,n,b);f.push(F);S=R(E);w&&f.push({x:q,y:n,ctx:e,type:F.type,size:F.size,
color:S,borderColor:S,borderThickness:F.borderThickness})}if(m[p].indexLabel||k.indexLabel||m[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:m[p].y[0]<=m[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[p],dataSeries:k,indexKeyword:1,point:{x:q,y:n},direction:m[p].y[0]<=m[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&
(0<s.length&&(k.options.nullDataLineDashType||!m[p-1].lineDashType))&&(s[s.length-1].newLineDashArray=A,C=k.nullDataLineDashType):(d(D,y),s=[],x=[])),g=!0;d(D,y);X.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};n.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,l=0,t,h,k,m,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
Math.abs(q)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&l>h&&(l=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,h));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&h<l)&&(h=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>h&&(q=h);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,
f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var n=a.dataSeriesIndexes[g],s=this.data[n],v=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var u="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,y=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var z=5<q&&s.bevelEnabled?!0:!1,C=!1,x=null,A=null,l=0;l<v.length;l++)if(v[l].getTime?
m=v[l].x.getTime():m=v[l].x,"number"!==typeof v[l].y){if(0<l&&!C&&s.connectNullData)var E=s.options.nullDataLineDashType||!v[l-1].lineDashType?s.nullDataLineDashType:v[l-1].lineDashType;C=!0}else{t=a.axisX.convertValueToPixel(m);h=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);t=a.axisX.reversed?t+a.plotType.totalDataSeries*
q/2-(a.previousDataSeriesCount+g)*q<<0:t-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var F=a.axisX.reversed?t-q<<0:t+q<<0;h>k&&(e=h,h=k,k=e);a.axisY.reversed&&(e=h,h=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:l,x1:t,y1:h,x2:F,y2:k};var S=v[l].color?v[l].color:0<v[l].y?s.risingColor:s.fallingColor;ba(c,t,h,F,k,S,0,S,z,z,!1,!1,s.fillOpacity);e=R(e);w&&ba(this._eventManager.ghostCtx,t,h,F,k,e,0,null,!1,
!1,!1,!1);var O,S=t;O="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?h:k:0<v[l].y?k:h;0<l&&x&&(!C||s.connectNullData)&&(C&&c.setLineDash&&c.setLineDash(N(E,u)),c.beginPath(),c.moveTo(x,A-y),c.lineTo(S,O-y),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(x,A-y),b.lineTo(S,O-y),0<u&&b.stroke()));C=!1;x=F;A=0<v[l].y?h:k;S=v[l].lineDashType?v[l].lineDashType:s.options.lineDashType?s.options.lineDashType:
...
l=z.y-1*w,h=z.y+1*w;if(0<=a&&a<m.length){var p=g[a];if(0>c&&p.indexLabelTextBlock.y<l||0<c&&p.indexLabelTextBlock.y>h)return 0;var q=0,t=0,t=q=q=0;0>c?p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2>l&&p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2+c<l&&(c=-(l-(p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2+c))):p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2<l&&p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c>h&&(c=p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/
2+c-h);c=p.indexLabelTextBlock.y+c;l=0;l="right"===p.hemisphere?z.x+Math.sqrt(Math.pow(w,2)-Math.pow(c-z.y,2)):z.x-Math.sqrt(Math.pow(w,2)-Math.pow(c-z.y,2));t=z.x+A*Math.cos(p.midAngle);q=z.y+A*Math.sin(p.midAngle);q=Math.sqrt(Math.pow(l-t,2)+Math.pow(c-q,2));t=Math.acos(A/w);q=Math.acos((w*w+A*A-q*q)/(2*A*w));c=q<t?c-p.indexLabelTextBlock.y:0;l=null;for(h=1;h<m.length;h++)if(l=(a-h+g.length)%g.length,g[l].hemisphere!==g[a].hemisphere){l=null;break}else if(g[l].indexLabelText&&g[l].hemisphere===
g[a].hemisphere&&l!==a&&(0>b(g[l],g[a])||("right"===g[a].hemisphere?g[l].indexLabelTextBlock.y<=g[a].indexLabelTextBlock.y:g[l].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y)))break;else l=null;t=l;q=e(a);h=l=0;0>c?(h="right"===p.hemisphere?t:q,k=c,null!==h&&(t=-c,c=p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2-(g[h].indexLabelTextBlock.y+g[h].indexLabelTextBlock.height/2),c-t<r&&(l=-t,h=f(h,l,d+1),+h.toFixed(y)>+l.toFixed(y)&&(k=c>r?-(c-r):-(t-(h-l)))))):0<c&&(h="right"===p.hemisphere?
q:t,k=c,null!==h&&(t=c,c=g[h].indexLabelTextBlock.y-g[h].indexLabelTextBlock.height/2-(p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2),c-t<r&&(l=t,h=f(h,l,d+1),+h.toFixed(y)<+l.toFixed(y)&&(k=c>r?c-r:t-(l-h)))));k&&(d=p.indexLabelTextBlock.y+k,c=0,c="right"===p.hemisphere?z.x+Math.sqrt(Math.pow(w,2)-Math.pow(d-z.y,2)):z.x-Math.sqrt(Math.pow(w,2)-Math.pow(d-z.y,2)),p.midAngle>Math.PI/2-u&&p.midAngle<Math.PI/2+u?(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"left"===p.hemisphere&&
"right"===l.hemisphere&&c>l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x-15:"right"===p.hemisphere&&("left"===a.hemisphere&&c<a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x+15)):p.midAngle>3*Math.PI/2-u&&p.midAngle<3*Math.PI/2+u&&(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"right"===p.hemisphere&&"left"===l.hemisphere&&c<l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x+15:"left"===p.hemisphere&&("right"===a.hemisphere&&c>a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x-
15)),p.indexLabelTextBlock.y=d,p.indexLabelTextBlock.x=c,p.indexLabelAngle=Math.atan2(p.indexLabelTextBlock.y-z.y,p.indexLabelTextBlock.x-z.x))}return k}function l(){var a=n.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&A-d<=E)l=!1;l&&(A-=d);d=0;if("inside"!==k.indexLabelPlacement){w=A*v;for(a=0;a<m.length;a++){var h=
g[a];h.indexLabelTextBlock.x=z.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=z.y+w*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=A;h.percentInnerRadius=F}for(var t,s,a=0;a<m.length;a++){var h=g[a],u=e(a);if(null!==u){t=g[a];s=g[u];var C=0,C=b(t,s)-r;if(0>C){for(var x=s=0,D=0;D<m.length;D++)D!==a&&g[D].hemisphere===h.hemisphere&&(g[D].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:x++);s=C/(s+x||1)*x;var x=-1*(C-s),I=D=0;"right"===h.hemisphere?(D=f(a,s),x=-1*(C-D),I=f(u,x),+I.toFixed(y)<
+x.toFixed(y)&&+D.toFixed(y)<=+s.toFixed(y)&&f(a,-(x-I))):(D=f(u,s),x=-1*(C-D),I=f(a,x),+I.toFixed(y)<+x.toFixed(y)&&+D.toFixed(y)<=+s.toFixed(y)&&f(u,-(x-I)))}}}}else for(a=0;a<m.length;a++)h=g[a],w="pie"===k.type?0.7*A:0.8*A,u=z.x+w*Math.cos(h.midAngle),s=z.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=u,h.indexLabelTextBlock.y=s;for(a=0;a<m.length;a++)if(h=g[a],u=h.indexLabelTextBlock.measureText(),0!==u.height&&0!==u.width)u=u=0,"right"===h.hemisphere?(u=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+
...
g)return-1;for(var l=d[0]=0,h=0,m,p,b=b-a,l=!1,k=0;k<y.length;k++)a=Math.abs(y[k].y)*f/g,l?m=0==Number(c.toFixed(3))?0:a/c:(p=Z*Z*b*b-4*Math.abs(Z)*a,0>p?(p=c,l=(b+p)*(e-h)/2,a-=l,m=e-h,h+=e-h,m+=0==p?0:a/p,h+=a/p,l=!0):(m=(Math.abs(Z)*b-Math.sqrt(p))/2,p=b-2*m/Math.abs(Z),h+=m,h>e&&(h-=m,p=c,l=(b+p)*(e-h)/2,a-=l,m=e-h,h+=e-h,m+=a/p,h+=a/p,l=!0),b=p)),d.push(m);return d}function b(){if(u&&y){for(var a,b,c,d,e,f,k,l,h,m,p,q,t,n,r,B=[],v=[],z={percent:null,total:null},C=null,A=0;A<y.length;A++)r=Q[A],
r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,B[A]=J-r-T;r=0.5*T;for(var A=0,D=y.length-1;A<y.length||0<=D;A++,D--){b=u.reversed?y[D]:y[A];a=b.color?b.color:u.reversed?u._colorSet[(y.length-1-A)%u._colorSet.length]:u._colorSet[A%u._colorSet.length];c=b.indexLabelPlacement||u.indexLabelPlacement||"outside";n=b.indexLabelTextAlign||u.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||u.indexLabelBackgroundColor||(w?"transparent":null);e=b.indexLabelFontColor||u.indexLabelFontColor||
...
u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:B[A];if(t>B[A]||0>t)t=B[A];v[A]="inside"===u.indexLabelPlacement?Q[A].height:!1;z=x.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)C={chart:x.options,dataSeries:u,dataPoint:b,total:z.total,percent:z.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?x.replaceKeywordsWithValue(b.indexLabel,b,u,A):u.indexLabelFormatter?u.indexLabelFormatter(C):u.indexLabel?x.replaceKeywordsWithValue(u.indexLabel,b,u,A):b.label?
b.label:"";0>=m&&(m=0);1E3>t&&1E3-t<r&&(t+=1E3-t);R.roundRect||Aa(R);c=new ha(R,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:n,backgroundColor:d,maxWidth:t,maxHeight:!1===v[A]?q?4.28571429*f:1.5*f:v[A],text:b,padding:ca});c.measureText();H.push({textBlock:c,id:u.reversed?D:A,isDirty:!1,lineColor:a,lineThickness:m,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=
[];e=!1;c=0;for(var g,k=J-Y-T/2,k=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>k?k:u.indexLabelMaxWidth:k,l=H.length-1;0<=l;l--){g=y[H[l].id];c=H[l];d=c.textBlock;b=(a=q(l)<Q.length?H[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ca>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=H.length-1;0<=l;l--)a=Q[l],H[l].textBlock.maxWidth=f[f.length-(l+1)],H[l].textBlock.measureText(),H[l].textBlock.x=J-k,c=H[l].textBlock.height<H[l].textBlock.maxHeight?H[l].textBlock.height:
H[l].textBlock.maxHeight,e=H[l].textBlock.width<H[l].textBlock.maxWidth?H[l].textBlock.width:H[l].textBlock.maxWidth,H[l].height=c,H[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,H[l].textBlock.y=c-H[l].height/2,u.reversed?(H[l].textBlock.y+H[l].height>ma+C&&(H[l].textBlock.y=ma+C-H[l].height),H[l].textBlock.y<qa-C&&(H[l].textBlock.y=qa-C)):(H[l].textBlock.y<ma-C&&(H[l].textBlock.y=ma-C),H[l].textBlock.y+H[l].height>qa+C&&(H[l].textBlock.y=qa+C-H[l].height))}function f(){var a,
b,c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<Q.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=Q[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>va?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<va?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,H[e].textBlock.x=b+T,H[e].textBlock.y=c-H[e].height/2,u.reversed?(H[e].textBlock.y+H[e].height>ma+C&&(H[e].textBlock.y=ma+C-H[e].height),H[e].textBlock.y<qa-C&&(H[e].textBlock.y=
qa-C)):(H[e].textBlock.y<ma-C&&(H[e].textBlock.y=ma-C),H[e].textBlock.y+H[e].height>qa+C&&(H[e].textBlock.y=qa+C-H[e].height)));else for(e=0;e<Q.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=Q[e],b=a.height,c=H[e].height,d=H[e].width,b>=c?(b=e!=ba?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ba?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,H[e].textBlock.x=b,H[e].textBlock.y=c):H[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=H.length)return 0;var e,f=H[b].textBlock;if(0>c){c*=-1;e=
...
H[t].height-e>e-H[t].textBlock.y?e+1:e-H[t].height-1))}for(l=Q.length-1;0<l;l--)if(!H[l].isDirty){e=p(l);if(0>e&&(e=0,H[e].isDirty))break;if(H[l].textBlock.y<H[e].textBlock.y+H[e].height){d=d||l;f=l;for(k=0;H[f].textBlock.y<H[e].textBlock.y+H[e].height+ca;){a=a||H[f].textBlock.y+H[f].height;k+=H[f].height;k+=ca;f=e;if(0>=f){f=0;k+=H[f].height;break}e=p(f);if(0>e){f=0;k+=H[f].height;break}}if(f!=l){g=H[f].textBlock.y;a-=g;a=k-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=
b;d++)e.push(Q[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=H[b.id].height+ca,H[b.id].textBlock.text="",H[b.id].indexLabelText="",H[b.id].isDirty=!0,H[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,k,l,m=1,n=0;n<2*m;n++){for(var r=H.length-1;0<=r&&!(0<=p(r)&&p(r),f=H[r],g=f.textBlock,l=(k=q(r)<Q.length?H[q(r)]:null)?k.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(k&&e+d+ca>+l.y.toFixed(6))&&(d=g.y+d+ca-l.y,
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<Q.length?H[b].textBlock.y:u.reversed?ma+C:qa+C)-(0>a?u.reversed?qa-C:ma-C:H[a].textBlock.y+H[a].height+ca)}function n(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=W.indexOf(b)?(e=W.indexOf(b),W.splice(e,1)):(W.push(b),W=W.sort(function(a,b){return a-b})));if(0===W.length)l=fa;else{e=C*(1!=W.length||0!=W[0]&&W[0]!=Q.length-1?2:1)/k();for(var t=0;t<Q.length;t++){if(1==W.length&&0==W[0]){if(0===t){l.push(fa[t]);d=h;continue}}else 0===
...
b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ga=!0;d.clearRect(z.x1,z.y1,z.x2-z.x1,z.y2-z.y1);d.fillStyle=a.backgroundColor;d.fillRect(z.x1,z.y1,z.width,z.height);q.changeSection(c,b);var e={};e.dataSeries=u;e.dataPoint=u.reversed?u.dataPoints[y.length-1-b]:u.dataPoints[b];e.index=u.reversed?y.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<Q.length;e++)pa(d,Q[e],u.fillOpacity);v(d);I&&("inside"!==u.indexLabelPlacement?m(d):f(),r(d));1<=c&&(ga=!1)},null,M.easing.easeOutQuart)}
function k(){for(var a=0,b=0;b<Q.length-1;b++)(0<=W.indexOf(b)||0<=W.indexOf(b+1))&&a++;return a}function m(a){for(var b,c,d,e,f=0;f<Q.length;f++)e=1===H[f].lineThickness%2?0.5:0,c=((Q[f].y2+Q[f].y4)/2<<0)+e,b=g(c).x2-1,d=H[f].textBlock.x,e=(H[f].textBlock.y+H[f].height/2<<0)+e,H[f].isDirty||0==H[f].lineThickness||(a.strokeStyle=H[f].lineColor,a.lineWidth=H[f].lineThickness,a.setLineDash&&a.setLineDash(N(H[f].lineDashType,H[f].lineThickness)),a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}
function p(a){for(a-=1;-1<=a&&-1!=a&&H[a].isDirty;a--);return a}function q(a){for(a+=1;a<=Q.length&&a!=Q.length&&H[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<y.length;c++)if(Q[c].y1<a&&Q[c].y4>a){b=Q[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function r(a){for(var b=0;b<Q.length;b++)H[b].isDirty||(a&&(H[b].textBlock.ctx=a),H[b].textBlock.render(!0))}function v(a){x.plotArea.layoutManager.reset();
...
Fa.fNg&&Fa.fNg(x)}var x=this;if(!(0>=a.dataSeriesIndexes.length)){for(var u=this.data[a.dataSeriesIndexes[0]],y=u.dataPoints,z=this.plotArea,C=0.025*z.width,D=0.01*z.width,A=0,E=z.height-2*C,F=Math.min(z.width-2*D,2.8*z.height),I=!1,O=0;O<y.length;O++)if(!I&&("undefined"!==typeof y[O].indexLabel&&null!==y[O].indexLabel&&0<y[O].indexLabel.toString().length)&&(I=!0),!I&&("undefined"!==typeof y[O].label&&null!==y[O].label&&0<y[O].label.toString().length)&&(I=!0),!I&&"function"===typeof u.indexLabelFormatter||
"function"===typeof y[O].indexLabelFormatter)I=!0;I=I||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&I||(D=(z.width-0.75*F)/2);var O=z.x1+D,J=z.x2-D,K=z.y1+C,P=z.y2-C,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==y.length){var aa,G;a=75*F/100;var T=30*(J-a)/100;"funnel"===u.type?(aa=s(u.options.neckHeight)?0.35*E:u.neckHeight,G=s(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===
typeof aa&&aa.match(/%$/)?(aa=parseInt(aa),aa=aa*E/100):aa=parseInt(aa),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),aa>E?aa=E:0>=aa&&(aa=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=aa=0,u.reversed=u.reversed?!1:!0);var D=O+a/2,U=O,Y=O+a,ma=u.reversed?P:K,L=D-G/2,X=D+G/2,va=u.reversed?K+aa:P-aa,qa=u.reversed?K:P;a=[];var D=[],Q=[],F=[],V=K,ba,Z=(va-ma)/(L-U),da=-Z,O="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==O){if(u.reversed)for(F.push(V),
G=O.length-1;0<G;G--)V+=O[G],F.push(V);else for(G=0;G<O.length;G++)V+=O[G],F.push(V);if(u.reversed)for(G=0;G<O.length;G++)F[G]<va?(a.push(L),D.push(X),ba=G):(a.push((F[G]-ma+Z*U)/Z),D.push((F[G]-ma+da*Y)/da));else for(G=0;G<O.length;G++)F[G]<va?(a.push((F[G]-ma+Z*U)/Z),D.push((F[G]-ma+da*Y)/da),ba=G):(a.push(L),D.push(X));for(G=0;G<O.length-1;G++)V=u.reversed?y[y.length-1-G].color?y[y.length-1-G].color:u._colorSet[(y.length-1-G)%u._colorSet.length]:y[G].color?y[G].color:u._colorSet[G%u._colorSet.length],
G===ba?Q.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:X,y3:va,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:L,y6:va,id:G,height:F[G+1]-F[G],color:V}):Q.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:V});var ca=2,H=[],ga=!1,W=[],fa=[],O=!1;a=a=0;Ba(W);for(G=0;G<y.length;G++)y[G].exploded&&(O=!0,u.reversed?W.push(y.length-1-G):W.push(G));R.clearRect(z.x1,z.y1,z.width,z.height);R.fillStyle=x.backgroundColor;R.fillRect(z.x1,z.y1,z.width,z.height);
if(I&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(G=0;G<y.length;G++)H[G].isDirty||(a=H[G].textBlock.x+H[G].width,a=(J-a)/2,0==G&&(A=a),A>a&&(A=a));for(G=0;G<Q.length;G++)Q[G].x1+=A,Q[G].x2+=A,Q[G].x3+=A,Q[G].x4+=A,Q[G].x5&&(Q[G].x5+=A,Q[G].x6+=A),H[G].textBlock.x+=A}for(G=0;G<Q.length;G++)A=Q[G],pa(R,A,u.fillOpacity),fa.push(A.y1);v(R);I&&u.visible&&("inside"===u.indexLabelPlacement||x.animationEnabled||m(R),x.animationEnabled||r());if(!I)for(G=0;G<y.length;G++)A=u.dataPointIds[G],
a={id:A,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:Q[u.reversed?y.length-1-G:G]},x._eventManager.objectMap[A]=a;!x.animationEnabled&&O?n(x,-1,0):x.animationEnabled&&!x.animatedRender&&n(x,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ga&&!x.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?y.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===u.type)u.reversed?y[y.length-1-a].exploded=
y[y.length-1-a].exploded?!1:!0:y[a].exploded=y[a].exploded?!1:!0;n(x,b,500)}};return{source:R,dest:this.plotArea.ctx,animationCallback:function(a,b){M.fadeInAnimation(a,b);1<=a&&(n(x,-1,500),v(x.plotArea.ctx||x.ctx))},easingFunction:M.easing.easeInQuad,animationBase:0}}}}};n.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,
...
2}h+=m}};na(K,I);K.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"normal";if("bar"===a||"stackedBar"===
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return n}();x.version="v3.4.11 GA";window.CanvasJS&&(x&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=x)})();
