...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaScope = "/guest/";
    var pwaLocation = "/guest/_service-worker.js";
    ...
    function init_template(){
        ...
        highlightData.forEach(el => el.addEventListener('click', e =>{
            ...
            loadHighlight.href = '/guest/styles/highlights/highlight_' + highlight +'.css';
        ...
        if(rememberHighlight){
            ...
            loadHighlight.className = "page-highlight";
            loadHighlight.type = "text/css";
            loadHighlight.href = '/guest/styles/highlights/highlight_' + rememberHighlight +'.css';
