...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('guest/styles/bootstrap.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('guest/styles/style.css')}}">
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,700,700i,900,900i|Source+Sans+Pro:300,300i,400,400i,600,600i,700,700i,900,900i&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('guest/fonts/css/fontawesome-all.min.css')}}">
    <link rel="manifest" href="{{URL::asset('guest/_manifest.json')}}" data-pwa-version="set_in_manifest_and_pwa_js">
    <link rel="apple-touch-icon" sizes="180x180" href="{{URL::asset('guest/app/icons/icon-192x192.png')}}">
</head>
...
<body class="theme-light" data-highlight="highlight-red" data-gradient="body-default">
    ...
    <div id="page">
        ...
        <div class="header header-fixed header-logo-center header-auto-show">
            <a href="index.html" class="header-title">{{ env('NAME') }}</a>
        ...
        <div class="page-content">
            ...
            <div class="footer card card-style">
                <a href="#" class="footer-title"><span class="color-highlight">Panti Rakyat</span></a>
                <p class="footer-text"><span>Dinas Sosial Kabupaten Muara Enim</span></p>
                <!--
            ...
            -->
                <p class="footer-copyright">Copyright &copy; Dinas Sosial Kabupaten Muara Enim <span id="copyright-year">2021</span>. All Rights Reserved.</p>
            </div>
    ...
    <script type="text/javascript" src="{{URL::asset('guest/scripts/bootstrap.min.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('guest/scripts/custom.js')}}"></script>
</body>
