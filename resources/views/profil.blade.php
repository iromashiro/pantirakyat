...
<div class="content">
    ...
    <div class="d-flex">
        <div class="me-auto"><span class="badge no-click bg-red-dark p-2 text-uppercase rounded-s mb-3">Profil</span></div>
        <div class="mx-auto"><span class="font-12"><i class="far fa-clock pe-2"></i>{{ $profil->created_at }}</span></div>
    </div>

    <img src="" class="img-fluid rounded-m">
